...
extern const unsigned char vert_mirror[13], turn_board[13];
...
/* from moves.c */
extern unsigned generate_moves(struct move*, const struct position*);
extern void turn_position(struct position*);
extern void apply_move(struct position *p, const struct move m);
